...
"highlight-table-of-content-item-using-intersection-observer.md": {
	id: "highlight-table-of-content-item-using-intersection-observer.md";
  slug: "highlight-table-of-content-item-using-intersection-observer";
  body: string;
  collection: "posts";
  data: any
} & { render(): Render[".md"] };
